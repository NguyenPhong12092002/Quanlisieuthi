    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        flb_addtv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EditText ed_diachi =(EditText) view1.findViewById(R.id.ed_diachi);
                ImageView imageView = (ImageView)view1.findViewById(R.id.img_liched) ;
                ...
                btn_them.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        if (ed_hoten.getText().length() == 0 || ed_namsinh.getText().length() == 0 || ed_diachi.getText().length() == 0) {
                            Toast.makeText(getActivity(), "Không được để trống", Toast.LENGTH_SHORT).show();
                        } else if (ed_hoten.getText().toString().length() < 5 || ed_hoten.getText().toString().length() > 15 || ed_diachi.getText().toString().length() > 15) {
                    ...
                    public void onClick(View v) {
                        ...
                        DatePickerDialog datePickerDialog = new DatePickerDialog(getContext(), new DatePickerDialog.OnDateSetListener() {
                            ...
                            public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                                ...
                                ed_namsinh.setText(sdf.format(calendar.getTime()));
                            }
