...
public class KhachhangDao {
    ...
    public long ADDTV(KhachHang khachHang) {
        ...
        contentValues.put(KhachHang.COL_NAME_diachi,khachHang.getDiachi());
    ...
    public int UPDATETV(KhachHang khachHang) {
        ...
        values.put(KhachHang.COL_NAME_diachi,khachHang.getDiachi());
    ...
    private List<KhachHang> getdata(String dl, String... Arays) {
        ...
        while (cursor.moveToNext()) {
            ...
            khachHang.setDiachi(cursor.getString(cursor.getColumnIndex(KhachHang.COL_NAME_diachi)));
            list.add(khachHang);
        }
        return list;
    }
